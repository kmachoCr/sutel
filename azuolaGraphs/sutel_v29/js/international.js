...
function drawDynamicInternationalAveragePerCapitaLineChart() {
    ...
    var data = google.visualization.arrayToDataTable([
        ['Pais', 'Ingreso Per Cápita Promedio', 'Porcentaje de Suscripciones Prepago'],
        ['Noruega',  {v:99636, f:'99.636'},  {v:26, f:'26%'}],
        ['Suiza',  {v:78928, f:'78.928'},  {v:39, f:'39%'}],
        ['Dinamarca', {v:56364, f:'56.364'},  {v:15, f:'15%'}],
        ['Singapur', {v:52052, f:'52.052'}, {v:47, f:'47%'}],
        ['Finlandia', {v:45694, f:'45.694'},  {v:10, f:'10%'}],
        ['Reino Unido', {v:38920, f:'38.920'}, {v:53, f:'53%'}],
        ['Chile', {v:15452, f:'15.452'}, {v:72, f:'72%'}],
        ['Uruguay', {v:14703, f:'14.703'},  {v:69, f:'69%'}],
        ['Brasil', {v:11339, f:'11.339'},  {v:85, f:'85%'}],
        ['México',  {v:9749, f:'9.749'},  {v:84, f:'84%'}],
        ['Panamá',  {v:9534, f:'9.534'},  {v:100, f:'100%'}],
        ['Costa Rica',   {v:9386, f:'9.386'},  {v:79, f:'79%'}],
        ['Colombia', {v:7748, f:'7.748'},  {v:81, f:'81%'}],
        ['Perú', {v:6796, f:'6.796'},  {v:76, f:'76%'}],
        ['Rep. Dominicana', {v:5746, f:'5.746'},  {v:82, f:'82%'}],
    ...
    var lineChart = new google.visualization.ChartWrapper({
        ...
        options: {
            ...
            hAxis: {title: ""},
            vAxes: {
                0: {logScale: false, title: "Dólares"},
...
google.load("visualization", "1", {packages:["corechart"]});
    ...
    function drawStaticInternationalLandLine100BarChart() {
      var data = google.visualization.arrayToDataTable([
     ["Pais", "Porcentaje %", { role: "style" } ],
        ["Nicaragua", {v:5, f:'5%'}, "#176b64"],
        ["Honduras", {v:8, f:'8%'}, "#176b64"],
        ["Guatemala", {v:8, f:'8%'}, "#176b64"],
        ["República Dominicana", {v:11, f:'11%'}, "#176b64"],
        ["Perú", {v:11, f:'11%'}, "#176b64"],
        ["Finlandia", {v:12, f:'12%'}, "#176b64"],
        ["Colombia", {v:15, f:'15%'}, "#176b64"],
        ["El Salvador", {v:15, f:'15%'}, "#176b64"],
        ["Panamá", {v:15, f:'15%'}, "#176b64"],
        ["México", {v:17, f:'17%'}, "#176b64"],
        ["Chile", {v:18, f:'18%'}, "#176b64"],
        ["Costa Rica", {v:20, f:'20%'}, "#e33061"],
        ["Brasil", {v:22, f:'22%'}, "#176b64"],
        ["Argentina", {v:23, f:'23%'}, "#176b64"],
        ["Noruega", {v:26, f:'26%'}, "#176b64"],
        ["Uruguay", {v:31, f:'31%'}, "#176b64"],
        ["Singapur", {v:36, f:'36%'}, "#176b64"],
        ["Dinamarca", {v:37, f:'37%'}, "#176b64"],
        ["Suecia", {v:41, f:'41%'}, "#176b64"],
        ["Estados Unidos", {v:42, f:'42%'}, "#176b64"],
        ["Países Bajos", {v:43, f:'43%'}, "#176b64"],
        ["Reino Unido", {v:53, f:'53%'}, "#176b64"],
        ["Suiza", {v:58, f:'58%'}, "#176b64"],
        ["Taiwán", {v:71, f:'71%'}, "#176b64"]
      ]);
...
google.load("visualization", "1", {packages:["corechart"]});
    ...
    function drawStaticInternationalCostaRicanMobileSubscriptionsBarChart() {
      var data = google.visualization.arrayToDataTable([
     ["Pais", "Porcentaje %", { role: "style" } ],
        ["México", {v:86, f:'86%'}, "#176b64"],
        ["Rep. Dominicana", {v:88, f:'88%'}, "#176b64"],
        ["EEUU", {v:96, f:'96%'}, "#176b64"],
        ["Honduras", {v:96, f:'96%'}, "#176b64"],
        ["Perú", {v:98, f:'98%'}, "#176b64"],
        ["Colombia", {v:104, f:'104%'}, "#176b64"],
        ["Noruega", {v:112, f:'112%'}, "#176b64"],
        ["Países Bajos", {v:114, f:'114%'}, "#176b64"],
        ["Nicaragua", {v:116, f:'116%'}, "#176b64"],
        ["Reino Unido", {v:124, f:'124%'}, "#176b64"],
        ["Suecia", {v:124, f:'124%'}, "#176b64"],
        ["Dinamarca", {v:127, f:'127%'}, "#176b64"],
        ["Taiwán", {v:127, f:'127%'}, "#176b64"],
        ["Suiza", {v:134, f:'134%'}, "#176b64"],
        ["Chile", {v:134, f:'134%'}, "#176b64"],
        ["Brasil", {v:135, f:'135%'}, "#176b64"],
        ["El Salvador", {v:136, f:'136%'}, "#176b64"],
        ["Guatemala", {v:140, f:'140%'}, "#176b64"],
        ["Costa Rica", {v:151, f:'151%'}, "#e33061"],
        ["Uruguay", {v:155, f:'155%'}, "#176b64"],
        ["Singapur", {v:156, f:'156%'}, "#176b64"],
        ["Argentina", {v:159, f:'159%'}, "#176b64"],
        ["Panamá", {v:163, f:'163%'}, "#176b64"],
        ["Finlandia", {v:172, f:'172%'}, "#176b64"]
      ]);
...
google.load("visualization", "1", {packages:["corechart"]});
    ...
    function drawStaticInternationalInternetAccess100BarChart() {
     ...
     ["Pais", "Porcentaje %", { role: "style" } ],
        ...
        ["Rep. Dominicana", {v:5, f:'5%'}, "#176b64"],
        ["Perú", {v:5, f:'5%'}, "#176b64"],
        ["Panamá", {v:8, f:'8%'}, "#176b64"],
        ["Colombia", {v:9, f:'9%'}, "#176b64"],
        ["Costa Rica", {v:10, f:'10%'}, "#e33061"],
        ["México", {v:11, f:'11%'}, "#176b64"],
        ["Chile", {v:12, f:'12%'}, "#176b64"],
        ["Uruguay", {v:21, f:'21%'}, "#176b64"],
        ["Taiwán", {v:24, f:'24%'}, "#176b64"],
        ["Singapur", {v:26, f:'26%'}, "#176b64"],
        ["Suecia", {v:33, f:'33%'}, "#176b64"],
        ["Reino Unido", {v:36, f:'36%'}, "#176b64"],
        ["Noruega", {v:36, f:'36%'}, "#176b64"],
        ["Países Bajos", {v:40, f:'40%'}, "#176b64"],
        ["Dinamarca", {v:40, f:'40%'}, "#176b64"],
        ["Suiza", {v:43, f:'43%'}, "#176b64"]
      ]);
...
google.load("visualization", "1", {packages:["corechart"]});
    ...
    function drawStaticInternationalMobileInternet100BarChart() {
     ...
     ["Pais", "Porcentaje %", { role: "style" } ],
        ...
        ["Rep. Dominicana", {v:15, f:'15%'}, "#176b64"],
        ["Argentina", {v:16, f:'16%'}, "#176b64"],
        ["Panamá", {v:25, f:'25%'}, "#176b64"],
        ["Chile", {v:28, f:'28%'}, "#176b64"],
        ["Uruguay", {v:32, f:'32%'}, "#176b64"],
        ["Brasil", {v:33, f:'33%'}, "#176b64"],
        ["Costa Rica", {v:57, f:'57%'}, "#e33061"],        
        ["Países Bajos", {v:61, f:'61%'}, "#176b64"],
        ["Reino Unido", {v:77, f:'77%'}, "#176b64"],
        ["Noruega", {v:84, f:'84%'}, "#176b64"],
        ["Estados Unidos", {v:89, f:'89%'}, "#176b64"],
        ["Dinamarca", {v:97, f:'97%'}, "#176b64"],
        ["Suecia", {v:105, f:'105%'}, "#176b64"],
        ["Finlandia", {v:106, f:'106%'}, "#176b64"],
        ["Singapur", {v:124, f:'124%'}, "#176b64"]
      ]);
...
function drawStaticInternationalTotalIncomeTelecommunicationsPIB100BarChart() {
    var data = google.visualization.arrayToDataTable([
   ["Pais", "Porcentaje %", { role: "style" } ],
      ["Noruega", {v:1.1, f:'1.1%'}, "#176b64"],
      ["Suecia", {v:1.5, f:'1.5%'}, "#176b64"],
      ["Países Bajos", {v:1.7, f:'1.7%'}, "#176b64"],
      ["Finlandia", {v:2.0, f:'2.0%'}, "#176b64"],
      ["Reino Unido", {v:2.0, f:'2.0%'}, "#176b64"],
      ["Dinamarca", {v:2.0, f:'2.0%'}, "#176b64"],
      ["Costa Rica", {v:2.3, f:'2.3%'}, "#e33061"],
      ["Panamá", {v:2.5, f:'2.5%'}, "#176b64"],
      ["Uruguay", {v:2.5, f:'2.5%'}, "#176b64"],
      ["Singapur", {v:2.5, f:'2.5%'}, "#176b64"],
      ["México", {v:2.6, f:'2.6%'}, "#176b64"],
      ["Perú", {v:2.7, f:'2.7%'}, "#176b64"],
      ["Brasil", {v:2.9, f:'2.9%'}, "#176b64"],
      ["Argentina", {v:2.9, f:'2.9%'}, "#176b64"],        
      ["Rep. Dominicana", {v:3.3, f:'3.3%'}, "#176b64"],
      ["EEUU", {v:3.4, f:'3.4%'}, "#176b64"],
