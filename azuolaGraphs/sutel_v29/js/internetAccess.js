...
function drawStaticInternetAccessTotalIncomeInternetServiceColumnChart() {
    var data = google.visualization.arrayToDataTable([
        ['Periodo', 'Millones'],
        ['2010 IV Trim',  {v:19102, f:'19.102'}],
        ['2011 I Trim',  {v:20336, f:'20.336'}],
        ['2011 II Trim', {v:21301, f:'21.301'}],
        ['2011 III Trim',  {v:20684, f:'20.684'}],
        ['2011 IV Trim',  {v:22797, f:'22.797'}],
        ['2012 I Trim',  {v:25678, f:'25.678'}],
        ['2012 II Trim',  {v:28184, f:'28.184'}],
        ['2012 III Trim',  {v:28019, f:'28.019'}],
        ['2012 IV Trim',  {v:27039, f:'27.039'}],
        ['2013 I Trim',  {v:34122, f:'34.122'}],
        ['2013 II Trim',  {v:38175, f:'38.175'}],
        ['2013 III Trim',  {v:44204, f:'44.204'}],
        ['2013 IV Trim',  {v:45413, f:'45.413'}]
    ]);
...
function drawStaticInternetAccessProportionRelativeIncomeStackedColumnChart() {
  var data = google.visualization.arrayToDataTable([
        ['Periodo', 'Fijo-alámbrico', 'Fijo inalámbrico', 'Móvil'],
...
function drawStaticInternetAccessSubscriptionsServiceAccessInternetMobileColumnChart() {
    var data = google.visualization.arrayToDataTable([
        ['Periodo', 'Cantidad de suscripciones'],
        ['2010 IV Trim',  {v:606215, f:'606.215'}],
        ['2011 I Trim',  {v:834350, f:'834.350'}],
        ['2011 II Trim', {v:925087, f:'925.087'}],
        ['2011 III Trim',  {v:1202865, f:'1.202.865'}],
        ['2011 IV Trim',  {v:1588981, f:'1.588.981'}],
        ['2012 I Trim',  {v:1988821, f:'1.988.821'}],
        ['2012 II Trim',  {v:2197211, f:'2.197.211'}],
        ['2012 III Trim',  {v:2426839, f:'2.426.839'}],
        ['2012 IV Trim',  {v:2670208, f:'2.670.208'}],
        ['2013 I Trim',  {v:2920000, f:'2.920.000'}],
        ['2013 II Trim',  {v:2961933, f:'2.961.933'}],
        ['2013 III Trim',  {v:3300029, f:'3.300.029'}],
        ['2013 IV Trim',  {v:3543419, f:'3.543.419'}]
    ]);
    ...
    var options = {
        ...
        height: dynamicHeight,
        legend: { position: "bottom" },
        vAxis: {title: "Cantidad de suscripciones"},
        colors:['#e33261'],
        chartArea: { 'left': leftSideMobile, 'top': topSideMobile, 'right': 0, 'bottom': 0, 'height': 'auto' }
...
function drawStaticInternetAccessProportionsServiceAccessInternetMobilePaymentStackedColumnChart() {
  var data = google.visualization.arrayToDataTable([
        ...
        ['I Trim 2013', {v:82, f:'82%'}, {v:18, f:'18%'}],
        ['II Trim 2013', {v:81, f:'81%'}, {v:19, f:'19%'}],
        ['III Trim 2013', {v:81, f:'81%'}, {v:19, f:'19%'}],
        ['IV Trim 2013', {v:78, f:'78%'}, {v:22, f:'22%'}]
      ]);
...
function drawStaticInternetAccessTrafficMonthlyAverageDataSubscription() {
  var data = google.visualization.arrayToDataTable([
        ['Periodo', 'Redes móviles', 'Redes fijas'],
        ['I Trim 2013', {v:568, f:'568'}, {v:17509, f:'17.509'}],
        ['II Trim 2013', {v:665, f:'665'}, {v:19081, f:'19.081'}],
        ['III Trim 2013', {v:716, f:'716'}, {v:22637, f:'22.637'}],
        ['IV Trim 2013', {v:703, f:'703'}, {v:25013, f:'25.013'}]
      ]);
