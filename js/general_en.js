...
function drawStaticGeneralTelecommunicationsIncome20112013ComboChart() {
  ...
  var options = {
      ...
      hAxis: {title: ""},
      vAxes: {
                0: {logScale: false, title: "Millions of colones"},
                1: {logScale: false, maxValue: 2, title: "Growth %"},
            },
      series:{
               0:{targetAxisIndex:0},
...
function drawStaticGeneralTelecommunicationsTotalIncomeService20112013StackedColumnChart() {
  var data = google.visualization.arrayToDataTable([
        ['Time Period','Telefonía móvil', 'Telefonía básica tradicional y telefonía VoIP', 'Internet','Líneas arrendadas'],
...
function drawStaticGeneralTelecommunicationsTotalIncomeServiceLineChart() {
  var data = google.visualization.arrayToDataTable([
    ['Time Period','Wired Telephony', 'Mobile Telephony', 'Internet Access', 'Rented Lines'],
