...
function drawStaticMobileTrafficVoicePerSubscriptionsComboChart() {
    var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Percentage %', 'Variation %'],
    ...
    var options = {
        ...
        legend: { position: "bottom" },
        vAxes: {
                0: {logScale: false, title: "Percentage %"},
                1: {logScale: false, maxValue: 2, title: "Variation %"},
        },   
        series:{
               0:{targetAxisIndex:0},
...
function drawStaticMobileEntryTotalMobileServiceLineChart() {
  var data = google.visualization.arrayToDataTable([
    ['Time Period', 'Millions of Colones'],
    ['I Quarter 2011',  {v:61688, f:'61.688'}],
    ['II Quarter 2011',  {v:65164, f:'65.164'}],
    ['III Quarter 2011',  {v:67103, f:'67.103'}],
    ['IV Quarter 2011',  {v:69718, f:'69.718'}],
    ['I Quarter 2012',  {v:75930, f:'75.930'}],
    ['II Quarter 2012',  {v:77393, f:'77.393'}],
    ['III Quarter 2012',  {v:79781, f:'79.781'}],
    ['IV Quarter 2012',  {v:81339, f:'81.339'}],
    ['I Quarter 2013',  {v:88703, f:'88.703'}],
    ['II Quarter 2013',  {v:92486, f:'92.486'}],
    ['III Quarter 2013',  {v:100956, f:'100.956'}],
    ['IV Quarter 2013',  {v:104673, f:'104.673'}],
  ]);
...
function drawStaticMobileEntryAssociatedMobileServicePerComponentStackedColumnChart() {
  var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Voice', 'SMS/MMS', 'Internet'],
        ['I Quarter 2011', {v:73, f:'73%'}, {v:17, f:'17%'}, {v:10, f:'10%'}],
        ['II Quarter 2011', {v:73, f:'73%'}, {v:17, f:'17%'}, {v:10, f:'10%'}],
        ['III Quarter 2011', {v:76, f:'76%'}, {v:16, f:'16%'}, {v:8, f:'8%'}],
        ['IV Quarter 2011', {v:75, f:'75%'}, {v:15, f:'15%'}, {v:10, f:'10%'}],
        ['I Quarter 2012', {v:74, f:'74%'}, {v:13, f:'13%'}, {v:13, f:'13%'}],
        ['II Quarter 2012', {v:73, f:'73%'}, {v:12, f:'12%'}, {v:15, f:'15%'}],
        ['III Quarter 2012', {v:74, f:'74%'}, {v:12, f:'12%'}, {v:14, f:'14%'}],
        ['IV Quarter 2012', {v:77, f:'77%'}, {v:12, f:'12%'}, {v:11, f:'11%'}],
        ['I Quarter 2013', {v:69, f:'69%'}, {v:10, f:'10%'}, {v:21, f:'21%'}],
        ['II Quarter 2013', {v:68, f:'68%'}, {v:9, f:'9%'}, {v:23, f:'23%'}],
        ['III Quarter 2013', {v:64, f:'64%'}, {v:10, f:'10%'}, {v:26, f:'26%'}],
        ['IV Quarter 2013', {v:64, f:'64%'}, {v:10, f:'10%'}, {v:26, f:'26%'}]
      ]);
...
function drawStaticMobileEntryPaymentMethodLineChart() {
  var data = google.visualization.arrayToDataTable([
    ...
    ['I Quarter 2011',  {v:26466, f:'26.466'}, {v:35202, f:'35.202'}],
    ['II Quarter 2011', {v:31182, f:'31.182'}, {v:33982, f:'33.982'}],
    ['III Quarter 2011', {v:34912, f:'34.912'}, {v:32191, f:'32.191'}],
    ['IV Quarter 2011', {v:38392, f:'38.392'}, {v:31327, f:'31.327'}],
    ['I Quarter 2012', {v:43625, f:'43.625'}, {v:32305, f:'32.305'}],
    ['II Quarter 2012', {v:44607, f:'44.607'}, {v:32786, f:'32.786'}],
    ['III Quarter 2012', {v:47238, f:'47.238'}, {v:32543, f:'32.543'}],
    ['IV Quarter 2012', {v:47904, f:'47.904'}, {v:33495, f:'33.495'}],
    ['I Quarter 2013', {v:47728, f:'47.728'}, {v:40975, f:'40.975'}],
    ['II Quarter 2013', {v:49327, f:'49.327'}, {v:43159, f:'43.159'}],
    ['III Quarter 2013', {v:54783, f:'54.783'}, {v:46174, f:'46.174'}],
    ['IV Quarter 2013', {v:55288, f:'55.288'}, {v:49384, f:'49.384'}],
  ]);
...
function drawDynamicLandlineActiveAvailableLinesComboChart () {
    ...
    var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Prepaid', 'Postpaid', 'Total'],
        ['2010 IV Quarter',  {v:1518914, f:'1.518.914'}, {v:1609458, f:'1.609.458'}, {v:3128372, f:'3.128.372'}],
        ['2011 I Quarter',  {v:1676271, f:'1.676.271'}, {v:1597757, f:'1.597.757'}, {v:3274028, f:'3.274.028'}],
        ['2011 II Quarter', {v:1934401, f:'1.934.401'}, {v:1571178, f:'1.571.178'}, {v:3505579, f:'3.505.579'}],
        ['2011 III Quarter',  {v:2123191, f:'2.123.191'}, {v:1561367, f:'1.561.367'}, {v:3684558, f:'3.684.558'}],
        ['2011 IV Quarter',  {v:2890378, f:'2.890.378'}, {v:1262689, f:'1.262.689'}, {v:4153067, f:'4.153.067'}],
        ['2012 I Quarter',  {v:3327675, f:'3.327.675'}, {v:1222583, f:'1.222.583'}, {v:4550258, f:'4.550.258'}],
        ['2012 II Quarter',  {v:3563225, f:'3.563.225'}, {v:1146930, f:'1.146.930'}, {v:4710155, f:'4.710.155'}],
        ['2012 III Quarter',  {v:3918197, f:'3.918.197'}, {v:1131617, f:'1.131.617'}, {v:5049814, f:'5.049.814'}],
        ['2012 IV Quarter',  {v:4240967, f:'4.240.967'}, {v:1137115, f:'1.137.115'}, {v:5378082, f:'5.378.082'}],
        ['2013 I Quarter',  {v:4583743, f:'4.583.743'}, {v:1155590, f:'1.155.590'}, {v:5739333, f:'5.739.333'}],
        ['2013 II Quarter',  {v:4859472, f:'4.859.472'}, {v:1144050, f:'1.144.050'}, {v:6003522, f:'6.003.522'}],
        ['2013 III Quarter',  {v:5426779, f:'5.426.779'}, {v:1167522, f:'1.167.522'}, {v:6594301, f:'6.594.301'}],
        ['2013 IV Quarter',  {v:5884388, f:'5.884.388'}, {v:1227593, f:'1.227.593'}, {v:7111981, f:'7.111.981'}]
    ]);
    ...
    var chart = new google.visualization.ChartWrapper({
        ...
        options: {
            ...
            hAxis: {title: ""},
            vAxes: {
                0: {logScale: false, title: "Subscriptions"}
            },
            series:{
               0:{color:'#8b509c'},
               1:{color:'#70b835'},
...
function drawDynamicMobileTrafficMobileVoiceComboChart () {
    ...
    var data = google.visualization.arrayToDataTable([
        ['Periodo', 'Prepaid', 'Postpaid', 'Total'],
        ['2011 I Quarter',  {v:658, f:'658'}, {v:875, f:'875'}, {v:1532, f:'1.532'}],
        ['2011 II Quarter', {v:773, f:'773'}, {v:783, f:'783'}, {v:1556, f:'1.556'}],
        ['2011 III Quarter', {v:951, f:'951'}, {v:776, f:'776'}, {v:1727, f:'1.727'}],
        ['2011 IV Quarter',  {v:1142, f:'1.142'}, {v:749, f:'749'}, {v:1892, f:'1.892'}],
        ['2012 I Quarter', {v:1267, f:'1.267'}, {v:688, f:'688'}, {v:1956, f:'1.956'}],
        ['2012 II Quarter', {v:1252, f:'1.252'}, {v:666, f:'666'}, {v:1918, f:'1.918'}],
        ['2012 III Quarter', {v:1303, f:'1.303'}, {v:716, f:'716'}, {v:2019, f:'2.019'}],
        ['2012 IV Quarter', {v:1407, f:'1.407'}, {v:645, f:'645'}, {v:2053, f:'2.053'}],
        ['2013 I Quarter', {v:1426, f:'1.426'}, {v:701, f:'701'}, {v:2127, f:'2.127'}],
        ['2013 II Quarter', {v:1482, f:'1.482'}, {v:697, f:'697'}, {v:2178, f:'2.178'}],
        ['2013 III Quarter', {v:1489, f:'1.489'}, {v:699, f:'699'}, {v:2187, f:'2.187'}],
        ['2013 IV Quarter', {v:1570, f:'1.570'}, {v:735, f:'735'}, {v:2306, f:'2.306'}]
    ]);
    ...
    var chart = new google.visualization.ChartWrapper({
        ...
        options: {
            ...
            hAxis: {title: ""},
            vAxes: {
                0: {logScale: false, title: "Millions of Minutes"}
            },
            series:{
               0:{color:'#8b509c'},
               1:{color:'#70b835'},
