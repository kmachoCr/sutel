...
function drawstaticTVSubscriptionsProportionHousesAccessTelevisionSubscription20102013ColumnChart() {
  ...
  ['Time Period', 'National Retail', 'National Wholesale', 'International Retail', 'International Wholesale'],
        ['2010 IV Quarter', {v:8547, f:'8.547'}, {v:0, f:'0'}, {v:0, f:'0'}, {v:0, f:'0'}],
        ['2011 I Quarter', {v:9043, f:'9.043'},  {v:0, f:'0'},  {v:0, f:'0'}, {v:0, f:'0'}],
        ['2011 II Quarter', {v:9207, f:'9.207'},  {v:0, f:'0'}, {v:32, f:'32'}, {v:0, f:'0'}],
        ['2011 III Quarter', {v:9903, f:'9.903'}, {v:0, f:'0'},  {v:121, f:'121'}, {v:0, f:'0'}],
        ['2011 IV Quarter', {v:10148, f:'10.148'}, {v:2, f:'2'}, {v:123, f:'123'}, {v:0, f:'0'}],
        ['2012 I Quarter', {v:10907, f:'10.907'}, {v:16, f:'16'}, {v:121, f:'121'}, {v:0, f:'0'}],
        ['2012 II Quarter', {v:11447, f:'11.447'}, {v:42, f:'42'}, {v:116, f:'116'}, {v:0, f:'0'}],
        ['2012 III Quarter', {v:11110, f:'11.110'}, {v:82, f:'82'}, {v:126, f:'126'}, {v:0, f:'0'}],
        ['2012 IV Quarter', {v:11774, f:'11.774'}, {v:97, f:'97'}, {v:122, f:'122'}, {v:0, f:'0'}],
        ['2013 I Quarter', {v:14918, f:'14.918'}, {v:175, f:'175'}, {v:122, f:'122'}, {v:0, f:'0'}],
        ['2013 II Quarter', {v:15246, f:'15.246'}, {v:262, f:'262'}, {v:118, f:'118'}, {v:0, f:'0'}],
        ['2013 III Quarter', {v:15701, f:'15.701'}, {v:308, f:'308'}, {v:118, f:'118'}, {v:0, f:'0'}],
        ['2013 IV Quarter', {v:15886, f:'15.886'}, {v:372, f:'372'},  {v:117, f:'117'}, {v:0, f:'0'}]    
     ]); 
...
function drawStaticLeasingLinesDistributionConnectionServiceBenefit2013ColumnChart1() {
    var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Connections', 'VPN', 'Frames', 'Ports', 'Fiber'],
        ['I Quarter 2013',  {v:49, f:'49%'},{v:41, f:'41%'}, {v:10, f:'10%'}, {v:0.3, f:'0.3%'}, {v:0, f:'0%'}],
        ['II Quarter 2013',  {v:48, f:'48%'}, {v:42, f:'42%'}, {v:9, f:'9%'}, {v:0.4, f:'0.4%'}, {v:0, f:'0%'}],
        ['III Quarter 2013',  {v:49, f:'49%'}, {v:41, f:'41%'}, {v:10, f:'10%'}, {v:0.3, f:'0.3%'}, {v:0, f:'0%'}],
        ['IV Quarter 2013',  {v:50, f:'50%'}, {v:41, f:'41%'}, {v:9, f:'9%'}, {v:0.3, f:'0.3%'}, {v:0, f:'0%'}]
    ]);
...
function drawStaticLeasingLinesTotalIncomeConnectionLeasingLines20102013ColumnChart() {
    var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Colones'],
        ['2010 IV Quarter',  {v:5608390, f:'5.608.390'}],
        ['2011 I Quarter',  {v:5867610, f:'5.867.610'}],
        ['2011 II Quarter', {v:6085199, f:'6.085.199'}],
        ['2011 III Quarter',  {v:6271039, f:'6.271.039'}],
        ['2011 IV Quarter',  {v:6311011, f:'6.311.011'}],
        ['2012 I Quarter',  {v:7562513, f:'7.562.513'}],
        ['2012 II Quarter',  {v:8300182, f:'8.300.182'}],
        ['2012 III Quarter',  {v:8665221, f:'8.665.221'}],
        ['2012 IV Quarter',  {v:9523891, f:'9.523.891'}],
        ['2013 I Quarter',  {v:9404059, f:'9.404.059'}],
        ['2013 II Quarter',  {v:10438847, f:'10.438.847'}],
        ['2013 III Quarter',  {v:10581178, f:'10.581.178'}],
        ['2013 IV Quarter',  {v:10676775, f:'10.676.775'}]
    ]);
    ...
    var options = {
        ...
        height: dynamicHeight,
        legend: { position: "bottom" },
        vAxis: {title: "Thousands of colones"},
        colors:['#5c6caf'],
    };
...
function drawStaticLeasingLinesDistributionConnectionServiceBenefit2013ColumnChartColumnChart() {
    var data = google.visualization.arrayToDataTable([
        ['Time Period', 'Connections', 'VPN', 'Frames', 'Ports', 'Fiber'],
        ['I Quarter 2013',  {v:53, f:'53%'},{v:39, f:'39%'}, {v:5, f:'5%'}, {v:2, f:'2%'}, {v:0.5, f:'0.5%'}],
        ['II Quarter 2013',  {v:56, f:'56%'}, {v:37, f:'37%'}, {v:5, f:'5%'}, {v:2, f:'2%'}, {v:0.4, f:'0.4%'}],
        ['III Quarter 2013',  {v:56, f:'56%'}, {v:36, f:'36%'}, {v:5, f:'5%'}, {v:2, f:'2%'}, {v:0.4, f:'0.4%'}],
        ['IV Quarter 2013',  {v:57, f:'57%'}, {v:36, f:'36%'}, {v:5, f:'5%'}, {v:2, f:'2%'}, {v:0.3, f:'0.3%'}]
    ]);
